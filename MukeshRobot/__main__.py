...
buttons = [
    [
        ...
        InlineKeyboardButton(text="🛡️ʀᴇꜱᴛʀɪᴄᴛ🛡️", callback_data="mukesh_"),
        InlineKeyboardButton(text="🖥️ᴄᴏᴍᴍᴀɴᴅꜱ🖥️", callback_data="Main_help"),
    ],
   [    
        InlineKeyboardButton(text="🧑‍💻ᴏᴡɴᴇʀ🧑‍💻", url=f"tg://user?id={OWNER_ID}"),
        InlineKeyboardButton(text="💳ꜱᴏᴜʀᴄᴇ💳", callback_data="source_"),
     ],
    [
...
ʏᴏᴜ ᴄᴀɴ ᴅɪʀᴇᴄᴛʟʏ ᴄᴏɴᴛᴀᴄᴛ ᴍʏ ᴅᴇᴠᴇʟᴏᴘᴇʀ @HKR_AIU ғᴏʀ ᴅᴏɴᴀᴛɪɴɢ ᴏʀ ʏᴏᴜ ᴄᴀɴ ᴠɪsɪᴛ ᴍʏ sᴜᴩᴩᴏʀᴛ ᴄʜᴀᴛ @hikaruDimari ᴀɴᴅ ᴀsᴋ ᴛʜᴇʀᴇ ᴀʙᴏᴜᴛ ᴅᴏɴᴀᴛɪᴏɴ."""
...
def Mukesh_about_callback(update: Update, context: CallbackContext):
    ...
    if query.data == "mukesh_":
        ...
        InlineKeyboardButton(text="🖥️", callback_data="Main_help"),
                    ...
                    [
                        InlineKeyboardButton(
                            text="🚩sᴜᴩᴩᴏʀᴛ", callback_data="hikaruDimari"
                        ),
                        InlineKeyboardButton(
...
ᴇx: /bug Hᴇʏ Tʜᴇʀᴇ Is ᴀ Sᴏᴍᴇᴛʜɪɴɢ Eʀʀᴏʀ @username ᴏғ ᴄʜᴀᴛ! .""",parse_mode=ParseMode.MARKDOWN,
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton(text="• ʙᴀᴄᴋ •", callback_data="Main_help"),InlineKeyboardButton(text="• sᴜᴘᴘᴏʀᴛ •", callback_data="hikaruDimari")
                    ]
                ]
            ),
            )                                        
...
Yᴏᴜ ᴄᴀɴ ʜᴇʟᴘ ᴛʜᴇ ᴅᴇᴠᴇʟᴏᴘᴍᴇɴᴛ ᴡɪᴛʜ ᴅᴏɴᴀᴛɪᴏɴs""",parse_mode=ParseMode.MARKDOWN,
        ...
        InlineKeyboardButton(text="🖥️", callback_data="Main_help"),
                    ...
                    [
                        InlineKeyboardButton(text="• Dᴏɴᴀᴛᴇ •", url="https://t.me/HKR_AIU"),InlineKeyboardButton(text="• sᴜᴘᴘᴏʀᴛ •", callback_data="hikaruDimari")
                    ]
                ]
            ),
            )  
...
""",
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton(text="• ʙᴀᴄᴋ •", callback_data="Music_"),InlineKeyboardButton(text="sᴜᴘᴘᴏʀᴛ", callback_data="hikaruDimari")
                    ]
                ]
            ),
        )
...
def get_help(update: Update, context: CallbackContext):
    ...
    if chat.type != chat.PRIVATE:
        ...
        send_help(
            ...
            text,
            InlineKeyboardMarkup(
                [[InlineKeyboardButton(text="◁", callback_data="help_back"),InlineKeyboardButton(text="sᴜᴘᴘᴏʀᴛ", callback_data="hikaruDimari")]]
            ),
        )
